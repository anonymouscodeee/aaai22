...
def main():
    ...
    parser.add_argument("--pred_model_dir", type=str,
                        default='../../models/python/0_train/checkpoint-best/',
                        help='model for prediction')  # prediction model
    parser.add_argument("--test_batch_size", type=int, default=1000)
    parser.add_argument("--test_result_dir", type=str, default='../../results/python/0_train',
                        help='path to store test result')  # result dir
    parser.add_argument("--test_file", type=bool, default=False,
